...
<div class="layout">
    ...
    <div class="layout-container">
        <div class="page-header">
            <div class="am-container">
                <h1 class="page-header-title">我的课程</h1>
            </div>
        </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <!--about-container end-->
                <table border="1px">
                    <c:forEach items="${requestScope.list}" var="courselist">
                        <tr>
                            <td>
                                <video width="150" height="100" controls="controls" autoplay="autoplay">
                                    <source src="${pageContext.request.contextPath}/upload/${courselist.couse.courseVideo}" type="video/ogg" />

                                </video>
                            </td>
                            <td>${courselist.couse.courseName}</td>
                            <td>${courselist.couse.schoolName}</td>
                            <td>${courselist.couse.orientation}</td>
                        </tr>
                    </c:forEach>
                </table>
        </div>
