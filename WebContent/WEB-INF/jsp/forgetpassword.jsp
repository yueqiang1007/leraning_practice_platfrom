...
<div class="layout">
    ...
    <div class="register-box">
        <form action="${pageContext.request.contextPath }/user/forgetePwdDo"
              method="post" class="am-form" data-am-validator>
            <fieldset>
                <legend>忘记密码<p class="register-info">密码必须以字母开头，只能存在字母和数字，必须大于6位</p></legend>
                    ...
                    <div class="am-g">
                        ...
                        <div class="am-u-md-10">
                            <input ype="text" name="phone_number" id="doc-vld-name-2" minlength="3"
                                   placeholder="电话号码（11个字符）" required/>
                        </div>
                    </div>
                </div>
                ...
                <div class="am-form-group">
                    <div class="am-g">
                        <div class="am-u-md-2 am-padding-0 am-text-right">
                            <label for="doc-vld-pwd-2">输入密码</label>
                        </div>
                        <div class="am-u-md-10">
                            <input type="password" name="password" id="doc-vld-pwd-2" placeholder="以字母开头至少6位"  required/>
                        </div>
                    </div>
                </div>
                ...
                <div class="am-form-group">
                    <div class="am-g">
                        ...
                        <div class="am-u-md-10">
                            <input type="password" name="fpwd"  placeholder="再输一次"  required/>
                        </div>
                    </div>
                </div>
