				...
				<div class="am-g">
					<div class="am-u-md-3">
						<div class="features_item">
							<img src="${pageContext.request.contextPath}/assets/images/index/f01.jpg" alt="">
					...
					<div class="am-u-md-3">
						<div class="features_item">
							<img src="${pageContext.request.contextPath}/assets/images/index/f02.jpg" alt="">
					...
					<div class="am-u-md-3">
						<div class="features_item">
							<img src="${pageContext.request.contextPath}/assets/images/index/f03.jpg" alt="">
					...
					<div class="am-u-md-3">
						<div class="features_item">
							<img src="${pageContext.request.contextPath}/assets/images/index/f04.jpg" alt="">
					...
					<div class="promo_detailed--cta">
						<div class="promo_detailed--cta_wrap">
							...
							<div class="promo_detailed--cta_footer">
								<a href="${pageContext.request.contextPath}/recruit/setRecruit">
								<button type="button" class="am-btn am-btn-danger">发布招聘&nbsp;&nbsp;>></button>
								</a>
							</div>
						</div>
